...
//  - only grades tradeable on Steam now. Celestial/Divine/Cosmic became tradeable after launch
//    (verified live 2026-07-07: e.g. "Shadow Bow (Celestial) A", "Ethereal Amulet (Cosmic) A"), so they
//    are bridged too. Re-check this set when the game opens up another grade.
...
const TRADE_NOW = new Set(['Legendary', 'Immortal', 'Arcana', 'Beyond', 'Celestial', 'Divine', 'Cosmic']);
